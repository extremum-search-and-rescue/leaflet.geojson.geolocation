const GeolocationMarker = L.CircleMarker.extend({
...
L.geolocationMarker = function(latlng, options) {
    return new GeolocationMarker(latlng, options);
}

const GeolocationLayer = L.GeoJsonLayer.extend({
    options: {
...
L.geolocationLayer = function(url, options){
    return new GeolocationLayer(url, options);
}